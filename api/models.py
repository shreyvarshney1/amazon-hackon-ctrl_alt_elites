...
class User(db.Model):
    ...
    profile_completeness_score = db.Column(db.Float, default=0.5) # Example: 1.0 if phone/address verified
...
class Product(db.Model):
    ...
    listed_at = db.Column(db.DateTime(timezone=True), server_default=func.now())
...
class Return(db.Model):
    ...
    reason_category = db.Column(db.String(100)) # e.g., 'counterfeit', 'damaged', 'not_as_described'
    created_at = db.Column(db.DateTime(timezone=True), server_default=func.now())
