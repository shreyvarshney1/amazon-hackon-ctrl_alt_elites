        ...
        <CardContent>
          <form onSubmit={handleSignup} className="space-y-4">
            ...
            <div className="space-y-1">
              ...
              <Input id="name" type="text" value={name} onChange={(e) => setName(e.target.value)} placeholder="First and last name" className="h-9" required disabled={isLoading} />
            </div>
            <div className="space-y-1">
              <Label htmlFor="email" className="text-sm font-medium">Email</Label>
              <Input id="email" type="email" value={email} onChange={(e) => setEmail(e.target.value)} className="h-9" required disabled={isLoading} />
            </div>
            <div className="space-y-1">
              <Label htmlFor="password">Password</Label>
              <Input id="password" type="password" value={password} onChange={(e) => setPassword(e.target.value)} placeholder="At least 6 characters" className="h-9" required disabled={isLoading} />
          ...
          <div className="pt-4 border-t border-gray-200 text-sm">
            ...
            <Link href="/login" className="text-blue-600 hover:text-orange-600 hover:underline">Sign in</Link>
          </div>
        </CardContent>
      </Card>
