...
const statusConfig: Record<OrderItem["status"], { text: string; className: string }> = {
  ...
  returned: { text: "Return Requested", className: "bg-blue-100 text-blue-800" },
  refunded: { text: "Refunded", className: "bg-gray-200 text-gray-800" },
  refund_rejected: { text: "Refund Rejected", className: "bg-pink-200 text-pink-800" },
};
